    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div id="immatinfo">
                ...
                <input class="form-control" name="D1_Marque" id="D1_Marque" required><br>

                <label for="D2_Version">Type - Variant - Version</label>
                <input class="form-control" name="D2_Version" id="D2_Version" required><br>

                <label for="K_NumRecpCE">Numéro de réception par type</label>
                <input class="form-control" name="K_NumRecpCE" id="K_NumRecpCE"><br>
                ...
                <input class="form-control" name="J_CategorieCE" id="J_CategorieCE"><br>

                <label for="J1_Genre">Genre national</label>
                <input class="form-control" name="J1_Genre" id="J1_Genre"><br>

                <label for="J3_Carrosserie">Carrosserie</label>
                <input class="form-control" name="J3_Carrosserie" id="J3_Carrosserie"><br>
